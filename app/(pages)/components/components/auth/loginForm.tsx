        ...
        <div className="p-6 pt-0">
          <form className="flex flex-col gap-4">
            <div className="space-y-2">
              ...
              <input
                className={`custom flex h-10 w-full rounded-md border bg-background px-3 py-2 text-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed `}
                type="email"
                placeholder="email"
              />
            </div>
