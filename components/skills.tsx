        ...
        <div className="w-full max-w-4xl mx-auto mt-6 rounded-xl flex flex-col gap-y-12 justify-center items-start">
            ...
            <div className="relative w-full">
              <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-4 items-center">
                {skillsArray.map((skill, index) => (
                  ...
                  >
                    <div className="text-2xl p-1 rounded">{skill.icon}</div>
                    <p className="font-normal font-bdog">{skill.skill}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          {pathName === "/" && (
            <div className="w-full grid grid-cols-1 gap-x-2 gap-y-4">
              <div>
                <h2 className="text-black mb-3 font-cal font-bold text-2xl">
                  Soft Skills
                </h2>
              </div>
              ...
              {softSkills.map((skill, i) => (
                <div className="min-w-[120px] py-4 px-3 ring-4 ring-neutral-800/5 gap-y-4 gap-x-4 justify-start items-center  border border-gray-200 rounded-lg flex">
                  <p className=" fancy font-bold opacity-100 hover:opacity-100 transition-all">
                    {skill.title}:{" "}
                    <span className="opacity-90 font-bdog font-light">
                      {skill.desc}
                    </span>
                  </p>
                </div>
