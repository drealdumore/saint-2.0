...
const Skills = () => {
  ...
  <div>
    ...
    <div className="w-full flex flex-col pb-8 gap-3 text-center">
      <div className="relative flex  justify-center">
        <span className="absolute -top90   text-4xl opacity-5" >Expertise
          💻</span>
      </div>
      <h2
        className="text-xl md:text-2xl md:leading-7.5 lg:leading-9 max-w-3xl mx-auto  font-normal opacity-80 leading-5.7">
        {/* style={{fontFamily: Moranga bold}}> //TODO: MAKE MORANNGA A DCELARED FONT AND IMPORT THE DECLARED VARIABLE */}
        In the past years, I have had the opportunity to gain expertise and proficiency in a diverse range of
        skills,
        including:</h2>
    </div>
    <div className="relative w-full">
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-4 items-center">
        <div
          className="min-w-[120px] py-4 px-3 tw-shadow gap-y-4 gap-x-4 justify-start items-center  border border-gray-200 rounded-lg hover:bg-gray-100 flex">
        ...
        <div
          ...
          <p className="font-normal">SCSS</p>
        </div>
        ...
        <div
          ...
          <p className="font-normal">Angular</p>
        </div>
        ...
        <div
          ...
          <div className="text-2xl p-1 rounded">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="1.5em" height="1.5em"
              viewBox="0 0 48 48">
              <linearGradient id="NRNx2IPDe7PJlJvrxOKgWa_MWiBjkuHeMVq_gr1" x1="24" x2="24" y1="43.734" y2="4.266"
        ...
        <div
          ...
          <p className="font-normal">Git - Version Control</p>
        </div>
  ...
  <div className="w-full grid grid-cols-1 gap-x-2 gap-y-4">
    <div>
      <h2 className="text-black mb-3 font-bold text-2xl">
        Soft Skills</h2>
    </div>
    <div
      className="min-w-[120px] py-4 px-3 tw-shadow gap-y-4 gap-x-4 justify-start items-center  border border-gray-200 rounded-lg hover:bg-gray-100 flex">
      <p className=" fancy font-bold opacity-100 hover:opacity-100 transition-all">Active listening:
        <span className="opacity-90  font-light">My strength in listening listing enables me to fully engage with
          others, fostering effective communication.</span>
      </p>
    </div>
    <div
      className="min-w-[120px] py-4 px-3 tw-shadow gap-y-4 gap-x-4 justify-start items-center  border border-gray-200 rounded-lg hover:bg-gray-100 flex">
      <p className=" fancy font-bold opacity-100 hover:opacity-100 transition-all">Effective Communication:
        <span className="opacity-90  font-light">I communicate complex technical concepts in a clear and
          understandable manner, fostering collaboration within the team.</span>
      </p>
    </div>
    <div
      className="min-w-[120px] py-4 px-3 tw-shadow gap-y-4 gap-x-4 justify-start items-center  border border-gray-200 rounded-lg hover:bg-gray-100 flex">
      <p className=" fancy font-bold opacity-100 hover:opacity-100 transition-all">Problem-Solving:
        <span className="opacity-90  font-light">I excel at analyzing and resolving challenges, approaching
          problems with a logical and creative mindset.</span>
      </p>
    </div>
    <div
      className="min-w-[120px] py-4 px-3 tw-shadow gap-y-4 gap-x-4 justify-start items-center  border border-gray-200 rounded-lg hover:bg-gray-100 flex">
      <p className=" fancy font-bold opacity-100 hover:opacity-100 transition-all">Attention to Detail:
        <span className="opacity-90  font-light">I meticulously review code and project details, ensuring
          high-quality work and minimizing errors.</span>
      </p>
    </div>
    <div
      className="min-w-[120px] py-4 px-3 tw-shadow gap-y-4 gap-x-4 justify-start items-center  border border-gray-200 rounded-lg hover:bg-gray-100 flex">
      <p className=" fancy font-bold opacity-100 hover:opacity-100 transition-all">Adaptability:
        <span className="opacity-90  font-light">I thrive in dynamic environments, quickly adapting to new
          technologies and evolving project requirements.</span>
      </p>

    </div>
    <div
      className="min-w-[120px] py-4 px-3 tw-shadow gap-y-4 gap-x-4 justify-start items-center  border border-gray-200 rounded-lg hover:bg-gray-100 flex">
      <p className=" fancy font-bold opacity-100 hover:opacity-100 transition-all">Continuous Learning:
        <span className="opacity-90  font-light">I am dedicated to staying abreast of industry trends,
          consistently upgrading my skills to deliver cutting-edge solutions.</span>
      </p>
    </div>
    <div
      className="min-w-[120px] py-4 px-3 tw-shadow gap-y-4 gap-x-4 justify-start items-center  border border-gray-200 rounded-lg hover:bg-gray-100 flex">
      <p className=" fancy font-bold opacity-100 hover:opacity-100 transition-all">Time Management:
        <span className="opacity-90  font-light">I efficiently prioritize tasks, meeting deadlines and delivering
          projects within specified timelines.</span>
      </p>
    </div>
  </div>
